...
fosofphasediff_c_columnname = "Phase Difference (Detector - Mixer 1, Corrected) [rad]"
...
fosofphasediffm2_c_columnname = "Phase Difference (Detector - Mixer 2, Corrected) [rad]"
